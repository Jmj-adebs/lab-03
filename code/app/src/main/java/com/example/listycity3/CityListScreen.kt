...
fun CityListScreen(
    ...
    Column(modifier = modifier.fillMaxSize()) {
        ...
        selectedCity?.let { cityBeingEdited ->
            var editCityName by remember(cityBeingEdited) { mutableStateOf(cityBeingEdited.name) }
            var editProvinceName by remember(cityBeingEdited) { mutableStateOf(cityBeingEdited.province) }
            Row(
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(16.dp)
